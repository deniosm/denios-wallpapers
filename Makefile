...
install:
	...
	cp denios-wallpapers.xml $(DESTDIR)/usr/share/gnome-background-properties/denios-wallpapers.xml
	cp denios-wallpapers.xml $(DESTDIR)/usr/share/mate-background-properties/denios-wallpapers.xml
